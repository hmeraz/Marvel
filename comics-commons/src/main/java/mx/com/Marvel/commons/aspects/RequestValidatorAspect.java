package mx.com.Marvel.commons.aspects;

import mx.com.Marvel.commons.exceptions.ForbiddenException;
import mx.com.Marvel.commons.exceptions.NotFoundException;
import mx.com.Marvel.commons.exceptions.ParametersException;
import mx.com.Marvel.commons.exceptions.UnauthorizedException;
import mx.com.Marvel.commons.to.ErrorTO;
...
public class RequestValidatorAspect {
    ...
    @Around(value = "execution(* mx.com.Marvel.web.rest.*.*(..))  && args(..)")
